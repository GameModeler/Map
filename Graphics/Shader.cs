...
namespace Map.Graphics
{
    ...
    public class Shader : ObjectBase
    {
        ...
        /// <exception cref="LoadingFailedException" />
        public Shader(Stream vertexShaderStream, Stream fragmentShaderStream) : base(IntPtr.Zero)
        {
            var vertexAdaptor = new StreamAdaptor(vertexShaderStream);
            var fragmentAdaptor = new StreamAdaptor(fragmentShaderStream);
            CPtr = sfShader_createFromStream(vertexAdaptor.InputStreamPtr, fragmentAdaptor.InputStreamPtr);
        ...
        {
            var ptr = sfShader_createFromMemory(vertexShader, fragmentShader);
            if (ptr == IntPtr.Zero)
            {
                throw new LoadingFailedException("shader");
            }
        ...
        {
            sfShader_setFloatParameter(CPtr, name, x);
        }
        ...
        {
            sfShader_setFloat2Parameter(CPtr, name, x, y);
        }
        ...
        {
            sfShader_setFloat3Parameter(CPtr, name, x, y, z);
        }
        ...
        {
            sfShader_setFloat4Parameter(CPtr, name, x, y, z, w);
        }
        ...
        public void SetParameter(string name, Vector2Df vector)
        {
        ...
        {
            sfShader_setColorParameter(CPtr, name, color);
        }
        ...
        {
            sfShader_setTransformParameter(CPtr, name, transform);
        }
        ...
        public void SetParameter(string name, Texture texture)
        {
            ...
            sfShader_setTextureParameter(CPtr, name, texture.CPtr);
        }
        ...
        {
            sfShader_setCurrentTextureParameter(CPtr, name);
        }
        ...
        {
            sfShader_bind(shader?.CPtr ?? IntPtr.Zero);
        }
