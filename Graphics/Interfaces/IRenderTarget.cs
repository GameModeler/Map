...
{
    /// <summary>
    /// Interface for render targets (render window, render image)
    /// </summary>
    public interface IRenderTarget
    {
        ...
        Vector2Df MapPixelToCoords(Vector2Di point);
        ...
        /// <returns>The converted point, in "world" coordinates</returns>
        Vector2Df MapPixelToCoords(Vector2Di point, View view);
        ...
        Vector2Di MapCoordsToPixel(Vector2Df point);
        ...
        /// <param name="view">The view to use for converting the point</param>
        /// <returns>The converted point, in target coordinates (pixels)</returns>
        Vector2Di MapCoordsToPixel(Vector2Df point, View view);
        ...
        /// <param name="type">Type of primitives to draw</param>
        void Draw(Vertex[] vertices, int start, int count, PrimitiveType type);
        ...
        /// <param name="type">Type of primitives to draw</param>
        /// <param name="states">Render states to use for drawing</param>
        void Draw(Vertex[] vertices, int start, int count, PrimitiveType type, RenderStates states);
